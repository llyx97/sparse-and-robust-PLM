...
class Trainer:
    ...
    def see_weight_rate(self, model, model_type):
        sum_list = 0
        zero_sum = 0
        if '%s.encoder.layer.0.attention.self.value.weight'%model_type in model.state_dict():
            suffix = '.weight'
        else:
            suffix = '.weight_mask'
        for ii in range(12):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    if (self.args.logging_steps > 0 and self.global_step % self.args.logging_steps == 0) or (
                        ...
                        logs["zero rate"] = self.see_weight_rate(model, model.config.model_type)
                        ...
                        if self.args.evaluate_during_training:
                            ...
                            json.dump(result_to_json, open(os.path.join(self.args.output_dir, "result.json"), 'w'))
