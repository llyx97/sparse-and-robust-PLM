...
export output_dir=$ROOT_DIR/log/mask_train/mask_on_plm_poe_ft/$robust_type/$TASK_NAME/$zero_rate
export model_dir=$ROOT_DIR/log/full_bert/$TASK_NAME/robust_train/$robust_type
